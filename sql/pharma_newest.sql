...
INSERT INTO `Customers` VALUES (1,'Jane','0123','ex@gmail.com'),(2,'John','0375296454','at@gmail.com'),(5,'AT','1234','anhthuhuynh9103@gmail.com'),(6,'Ngoc Anh Thu Huynh','090103','anhthuhuynh9103@gmail.com'),(7,'Kudo','0901','kudo@ex.com'),(9,'Noah','912003','noah@gmail.com'),(10,'Loki','5678','loki@ex.com'),(11,'Thor','6789','thor@ex.com');
...
CREATE TABLE `invoice_items` (
  ...
  CONSTRAINT `invoice_items_ibfk_249` FOREIGN KEY (`invoice_id`) REFERENCES `invoices` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `invoice_items_ibfk_250` FOREIGN KEY (`medicine_id`) REFERENCES `medicines` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `invoice_items` VALUES (7,3,1,5,8.50),(8,3,2,3,7.00),(10,4,5,5,10.00),(11,4,2,3,7.00),(12,5,3,5,12.00),(13,5,9,3,15.00),(16,7,14,10,30.00),(34,13,6,2,11.50),(35,13,15,1,6.00),(36,13,20,2,8.50),(42,17,6,10,11.50),(43,17,11,5,20.00),(45,19,2,20,7.00),(46,19,3,5,12.00),(47,20,2,5,7.00),(48,20,6,5,11.50),(49,20,8,5,8.00),(52,22,17,20,15.00),(67,24,9,10,15.00),(68,24,18,10,12.50),(69,24,17,1,15.00),(70,25,3,100,12.00),(71,26,5,30,10.00);
...
INSERT INTO `invoices` VALUES (3,'2024-12-15 12:00:00',63.50,'sale',1),(4,'2024-12-15 12:00:00',71.00,'sale',NULL),(5,'2024-12-15 12:00:00',105.00,'sale',2),(7,'2024-12-03 12:04:00',300.00,'purchase',NULL),(13,'2024-12-13 02:12:55',46.00,'sale',9),(17,'2024-12-13 02:23:00',215.00,'sale',2),(19,'2024-12-13 02:32:46',200.00,'sale',6),(20,'2024-12-13 02:43:07',132.50,'sale',5),(22,'2024-12-13 05:02:07',300.00,'sale',9),(24,'2024-12-13 07:12:33',290.00,'sale',9),(25,'2024-12-13 07:40:28',1200.00,'sale',7),(26,'2024-12-13 07:41:27',300.00,'sale',11);
...
-- Dump completed on 2024-12-13 15:55:02
