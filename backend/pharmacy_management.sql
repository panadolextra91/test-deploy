...
CREATE TABLE `invoice_items` (
  ...
  CONSTRAINT `invoice_items_ibfk_5` FOREIGN KEY (`invoice_id`) REFERENCES `invoices` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `invoice_items_ibfk_6` FOREIGN KEY (`medicine_id`) REFERENCES `medicines` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2024-12-03 10:49:02
